    ...
    */
    ...
    'connections' => [
        ...
        'wow_auth' => [
            ...
            'password' => env('DB_AUTH_PASSWORD', 'locbasepass%'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'wow_char' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_CHAR_HOST', '127.0.0.1'),
            'port' => env('DB_CHAR_PORT', '3306'),
            'database' => env('DB_CHAR_DATABASE', 'acore_characters'),
            'username' => env('DB_CHAR_USERNAME', 'root'),
            'password' => env('DB_CHAR_PASSWORD', 'locbasepass%'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
